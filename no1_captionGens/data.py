...
__COCO_IMG_PATH = "/home/lin7u/Downloads/dataset/coco2014/"
__COCO_ANN_PATH = "/home/lin7u/Downloads/dataset/coco2014/annotations/"
...
def build_vocab(annFile=__TRAIN_PATH['annFile'], num_words=10000):
    ...
    counts = {}
    coco = COCO(annFile)   # type(coco)=<class 'pycocotools.coco.COCO'>
    ids = coco.imgs.keys()
    #type(ids)=<class 'dict_keys'>,  len(ids)=82783,
    # ids=dict_keys([57870, 384029...)]

    #for img_id in ids:
    for img_id in [513729]:
        ann_ids = coco.getAnnIds(imgIds=img_id)
        # ann_ids=[787980, 789366, 789888, 791316, 794853],type(ann_ids)=<class 'list'>
        anns = coco.loadAnns(ann_ids)
        # anns={'image_id': 513729, 'id': 790053, 'caption': 'A police officer riding a blue and green motorcycle and reflective gear.'},{},{}]
        captions = simple_tokenize([ann['caption'] for ann in anns])
        # captions=[['a', 'police', 'officer', 'riding', 'a', 'blue', 'and', 'green', 'motorcycle', 'and', 'reflective', 'gear.'], ['the', 'motorcyclist', 'is', 'in', 'back', 'of', 'the', 'line', 'of', 'traffic,'], ['a', 'cop', 'riding', 'on', 'the', 'back', 'of', 'a', 'police', 'motorcycle.'], ['a', 'police', 'officer', 'is', 'riding', 'on', 'a', 'motorcycle'], ['a', 'police', 'officer', 'on', 'patrol', 'in', 'city', 'traffic.']] =============
        for txt in captions:
            for w in txt:
